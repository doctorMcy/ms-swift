...
class SwiftRLHF(SwiftSft):
    ...
    def _prepare_model_tokenizer(self):
        ...
        for key in ['ref', 'value', 'teacher']:
            ...
            if key == 'ref' and args.rlhf_type in ['gkd', 'opd']:
                continue
            if key == 'value' and args.rlhf_type != 'ppo':
                continue
            if key == 'teacher' and args.rlhf_type not in ['gkd', 'opd']:
                continue
    ...
    def _prepare_template(self) -> None:
        ...
        mode_mapping = {'kto': 'kto', 'gkd': 'gkd', 'opd': 'pt', 'ppo': 'pt', 'grpo': 'train'}
    ...
    def _get_trainer_kwargs(self):
        ...
        if self.args.rlhf_type in ['grpo', 'gkd', 'opd']:
        ...
        if self.args.rlhf_type in ['gkd', 'opd'] and self.args.teacher_deepspeed:
